# AngularFullPageWebsite

Application to Learn Angular concepts based on [Angular Tutorial](https://www.creativebloq.com/how-to/how-to-build-a-full-page-website-in-angular)
...
- [How to build a full-page website in Angular](https://www.creativebloq.com/how-to/how-to-build-a-full-page-website-in-angular)
...
```
    ng new AngularFullPageWebsite
```

3. Download code and follow guide on [How to build a full-page website in Angular](https://www.creativebloq.com/how-to/how-to-build-a-full-page-website-in-angular).
